...
class SimulationApp:
    ...
    def export_nozzle_pattern(self):
        ...
        try:
            self._run_headless_pattern_generation(parsed_recipe, filepath_img, filepath_vid, progress_widgets)
    ...
    def _run_headless_pattern_generation(self, recipe, filepath_img, filepath_vid, progress_widgets=None):
