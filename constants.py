...
ARM_GEOMETRIES = {
    1: {
        "pivot": np.array([-278.0, -220.5]), 
        "length": 354.83,
        "home": np.array([-248.309, 133.086]),
        "p_start": np.array([-115.948, 95.163]), 
        "p_end": np.array([66.267, -134.568])
    },
    2: {
        "pivot": np.array([278.0, -220.5]), 
        "length": 354.83,
        "home": np.array([248.926, 133.137]),
        "p_start": np.array([115.948, 95.163]), 
        "p_end": np.array([-66.267, -134.568])
    },
    3: {
        "pivot": np.array([185.3, -326]), 
        "length": 375.0,
        "home": np.array([-150, -158.075]),
        "p_start": np.array([-112.95720518685695, -98.69483165989139]), 
        "p_end": np.array([142.59091432950606, 46.55997369710882])
    }
}
