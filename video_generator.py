...
class VideoGenerator:
    ...
    def _run_headless_video_generation(self, recipe, filepath, progress_widgets, play_speed_multiplier=1.0):
        ...
        water_artists = {}
        for i in range(1, 4):
            falling, = ax.plot([], [], 'o', color=(0.6, 0.8, 1.0, 0.5), markersize=WATER_DROP_SIZE, zorder=10)
            on_wafer, = ax.plot([], [], '.', color=(0.6, 0.8, 1.0, 0.2), markersize=WATER_ON_WAFER_SIZE, zorder=3)
